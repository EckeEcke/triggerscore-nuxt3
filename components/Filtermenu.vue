        ...
        <div class="container hidden lg:block sm:px-4 xl:w-10/12 mx-auto">
            <div class="text-left pt-4 lg:pt-0 pb-5">
                ...
                <p class="text-sm text-white ">
                    {{ $t('index.intro1') }}
                    <span class="text-yellow-500 transition hover:text-yellow-600 font-semibold cursor-pointer" @click="focusSearch">
                        {{ $t('index.search') }}
                    </span>
                    {{ $t('index.intro2') }}
                </p>
            ...
            <div class="px-0 py-4 rounded-b text-white">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button class="font-semibold text-yellow-500 p-3 w-auto text-white uppercase" @click="resetFilter">
...
watch(() => store.sortingOption, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => store.filterMoviesByYearMin, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => store.filterMoviesByYearMax, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => store.shownScore, (currentValue, oldValue) => {
    store.filterMovies()
})
