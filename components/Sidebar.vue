...
watch(() => netflixFilter, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => primeFilter, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => disneyFilter, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => skyFilter, (currentValue, oldValue) => {
    store.filterMovies()
})
