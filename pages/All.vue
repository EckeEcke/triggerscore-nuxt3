...
const loadedMovies = computed(() => [...filteredMovies.value].filter((movie,index) => index >= start.value && index < end.value))
...
watch(() => movies.value, (currentValue, oldValue) => {
    store.filterMovies()
})

watch(() => filteredMovies.value, (currentValue, oldValue) => {
