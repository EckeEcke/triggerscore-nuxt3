<template>
  ...
  <div class="flex gap-6">
    ...
    <NuxtLink :to="redditLink" target="_blank" aria-label="Reddit Sharing">
      <img
        alt="reddit logo"
        class="w-10"
    ...
    <NuxtLink :to="facebookLink" target="_blank" aria-label="Facebook Sharing">
      <img
        alt="facebook logo"
        class="w-10"
    ...
    <NuxtLink :to="eMailLink" aria-label="Share by Email">
      <font-awesome-icon
        :icon="['fas', 'envelope']"
        class="text-white"
    ...
    >
      ...
      />
      <span v-if="copied" class="clipboard-info">
...
const whatsAppLink = computed(
  () =>
    "whatsapp://send?text=" +
    "Triggerscore - " +
    props.movie?.title.replace("&", "and") +
    " " +
    currentURL.value,
);
const redditLink = computed(
  () => "https://www.reddit.com/submit?url=" + currentURL.value,
);
