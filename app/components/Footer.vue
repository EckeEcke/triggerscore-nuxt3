  ...
  <footer class="w-full h-72 lg:h-64 py-2 bg-red-950 bg-opacity-90 shadow-md mt-auto">
    ...
    >
      ...
      <div class="self-center items-center grid my-2 px-2 grid-cols-3 lg:grid-cols-3 gap-4">
        ...
        <NuxtLink to="https://www.justwatch.com" target="blank">
          <img
            alt="Logo JustWatch"
        ...
        <NuxtLink to="https://www.nuxt.com" target="blank">
          <img
            alt="Logo Nuxt"
            class="w-12 lg:w-16 mx-auto"
            src="../assets/images/nuxt-logo.svg">
        </NuxtLink>
        <NuxtLink to="https://www.tailwindcss.com" target="blank">
          <img
            alt="Logo Tailwind"
            class="w-8 lg:w-12 mx-auto"
            src="../assets/images/tailwind.svg">
        </NuxtLink>
        <NuxtLink href="https://www.nodejs.org" target="blank">
          <img
            alt="Logo Node"
            class="w-10 lg:w-16 mx-auto"
            src="../assets/images/node-logo.svg">
        </NuxtLink>
        <NuxtLink to="https://www.mongodb.com/" target="blank">
          <img
            alt="Logo MongoDB"
            class="w-10 lg:w-16 mx-auto"
